                    ...
                    <div class="card card-outline card-info">
                        <div class="card-header">
                            <h3 class="card-title">
                                ...
                                <small>Cập nhật lần cuối vào: {{$activity->updated_at}}</small>
                            </h3>
                            <!-- tools box -->
                        ...
                        <div class="card-body pad">
                            <div class="mb-3">
                                <form method="post" enctype="multipart/form-data"
                                      action="{{route('admin.activities.update',['activity' => $activity->slug])}}">
                                    {{csrf_field()}}
                                    {{method_field('PUT')}}
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <p>Ảnh hiện tại</p>
                                                <img src="{{$activity->cover_img}}" width="120px">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
