    ...
    <div class="content-wrapper" style="min-height: 1231.06px;">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Đăng bài gây quỹ</h1>
                        <a role="button" href="{{route('member.news.create')}}" class="btn btn-success"><i
                                class="fas fa-plus"></i>Thêm bài viết gây quỹ</a>
                    </div>
                    <div class="col-sm-6">
                        ...
                        @foreach($posts as $index => $post)
                            <tr>
                                ...
                                <td class="project-state">
                                    ...
                                    <a class="btn btn-info btn-sm" href="{{route('member.news.edit',['id' => $post->id])}}">
                                    ...
                                    <form
                                        id={{'delete-'.$post->id}} action="{{route('member.news.destroy',['id' => $post->id])}}"
