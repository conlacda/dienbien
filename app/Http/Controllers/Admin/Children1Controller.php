...
class Children1Controller extends Controller
{
    public function __construct(ChildrenRepository $repo)
    {
        $repo->model = Children1::class;
        $this->repo = $repo;
        view()->share('modelName' , 'children1s');
        view()->share('title','Trẻ em tỉnh Điện Biên');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.children1s.index')->with('message', 'Tạo bài viết thành công');
    }
