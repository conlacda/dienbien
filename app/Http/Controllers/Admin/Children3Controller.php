...
class Children3Controller extends Controller
{
    public function __construct(ChildrenRepository $repo)
    {
        $repo->model = Children3::class;
        $this->repo = $repo;
        view()->share('modelName' , 'children3s');
        view()->share('title','Trẻ em đã được giúp đỡ');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.children3s.index')->with('message', 'Tạo bài viết thành công');
